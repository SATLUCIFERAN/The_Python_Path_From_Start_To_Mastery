...
class Padawan(JediKnight):
    ...
    def lightsaber_training(self):           
            super().lightsaber_training()            
            print(f"Now, {self.name} practices their Form I: Shii-Cho.")
...
luke = Padawan("Luke")
luke.lightsaber_training()


# --- The MRO in action ---
print("--- Unfurling the Padawan's Lineage Scroll (MRO) ---")
print(Padawan.mro())