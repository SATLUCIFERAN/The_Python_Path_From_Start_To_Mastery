# --- Data (tiny & readable) ---
bounties = [
    {"name":"Boba Fett",    "faction":"Bounty", "planet":"Tatooine",  "threat":5, "reward":12000},
    {"name":"Cad Bane",     "faction":"Bounty", "planet":"Nal Hutta", "threat":4, "reward": 9000},
    {"name":"Darth Maul",   "faction":"SITH",   "planet":"Mandalore", "threat":5, "reward":20000},
    {"name":"Hondo Ohnaka", "faction":"Pirate", "planet":"Florrum",   "threat":3, "reward": 4000},
    {"name":"DJ",           "faction":"Smuggler","planet":"Canto",    "threat":2, "reward": 1500},
]

# 1) List comprehension (+ conditional expression): make poster lines
posters = [
    f"{'🚨 DANGER' if b['threat']>=4 else '🟡 Wanted'} — {b['name']} on {b['planet']} ({'⭐'*b['threat']})"
    for b in bounties
]
